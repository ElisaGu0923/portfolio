...
export const projects: Project[] = [{ category: Category.WEB, title: "FlashCard", cover: cover, key: 4, imgs: [pic1, pic2, pic3], description: ["Full-stack Flash Card app built with Next.JS and MySQL", "Auth flow with AuthNext lib"], year: 2021 },
