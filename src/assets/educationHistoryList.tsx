...
export const educationHistoryList: Experience[] = [
    ...
    { name: "Object-Oriented Software Development", startDate: new Date('May, 2021'), endDate: new Date('August, 2021'), description: ["Coded, documented, debugged, and created test suites for medium-sized C++ programs", "Studied and implemented multiple design patterns", "Analysed and designed UML diagrams"] },
    ...
    { name: "Application Development", startDate: new Date('September, 2022'), endDate: new Date('December, 2022'), description: ["Working in a project team to design and build a full-stack desktop application and services with Kotlin and Gradle", "Created prototypes of software using Figma"] },
]
